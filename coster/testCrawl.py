...
'''class testCrawl:
    ...
    for i in link:
        url = 'http://land.mk.co.kr/memul/detail.php?bubcode=1135010300&mgroup=A&mclass=A01%2CA02%2CA03&bdiv=A&areadiv=&aptcode=&scalecode=&mseq={0}&xpos=&ypos=&tab=1&listOrder=&siteOrder=&JMJ='.format(i)
